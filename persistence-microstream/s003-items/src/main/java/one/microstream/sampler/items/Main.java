...
public class Main
{
	...
	{
		return (DataRoot)this.storageManager.root().get();
	}
	...
	private void command()
	{
		...
		if(command.startsWith("a "))
		{
			...
			{
				final List<Item> items = this.root().getItems();
		...
		else if(command.startsWith("s "))
		{
			...
			{
				final List<Item> items = this.root().getItems().stream()
